...
#Region "LOAD CONTENT"
    ...
    Public Shared Function AccountDetailsFromSummary() As FiltersOnLoad
        Dim ClientName As String = HttpContext.Current.Session("CPAFullName")
        ClientName = IIf(ClientName = Nothing, "", ClientName)
        Dim ClientID As String = HttpContext.Current.Session("CPAClientID")
        ClientID = IIf(ClientID = Nothing, "", ClientID)
    ...
    Public Shared Function ListAllRevisit(ByVal ClientID As String) As List(Of ReferencesForDropdown)
        ...
        If ClientID Is Nothing Then
            ClientID = HttpContext.Current.Session("CPAClientID")
        End If
...
#Region "UPDATE CONTENT"
    ...
    Public Shared Function addProspect(ByVal param As RevisitsDO) As String
        ...
        param.NewComments = If((Not param.NewRemarks = Nothing),
                                                OldRemarks & fontcolor & currentUser.DisplayName & " said on " _
                                                & My.Computer.Clock.LocalTime.ToString & " : " & param.NewRemarks & "</font><br>",
                                               OldRemarks & "")
