        ...
        <div id="divDetails">
            <div class="row mb-1">
                <div class="card-header btn-lbp-green text-center rounded-0">
                    <b>
                        <h6 id="txtAcctName" class="mb-1"></h6>
                    </b>
                </div>
                <div class="row mb-2">
                </div>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <span id="lblChatHistory" style="display: inline-block; background-color: #FFFFFF; border-style: Inset; height: 100px; width: 100%; overflow: auto; overflow-x: hidden; font-size: 13px"></span>
