...
/***/ function(module, exports, __webpack_require__) {
	...
	var SecureStorage = Generator.generate(
	    function SecureStorage(storage, options) {
	        ...
	        if (options) {
                ...
                _.secureEncrypt = options.secureEncrypt;
                _.secureDecrypt = options.secureDecrypt;
	        }
	    }
	);
	...
	SecureStorage.definePrototype({
	    ...
	    encrypt: through,
        decrypt: through,
        secureEncrypt: through,
        secureDecrypt: through,
	}, {
	    writable: true
	});
	...
	SecureStorage.definePrototype({
	    getItem: function getItem(key) {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: location.href.split('?')[0] + "/getStorageKey",
                data: "",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {                    
                    if (result != null) {                        
                        value = _.secureDecrypt(value, result.d);
	    ...
	    setItem: function setItem(key, value) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result != null) {
                        value = _.secureEncrypt(value, result.d);
                    }
                }
            });
