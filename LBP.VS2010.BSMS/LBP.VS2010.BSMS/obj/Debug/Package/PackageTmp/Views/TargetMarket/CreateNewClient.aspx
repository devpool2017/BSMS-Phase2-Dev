            ...
            <div id="collapseOne" class="accordion-collapse show" aria-labelledby="headingOne">
                <div class="accordion-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-1">
                            <input type="text" id="txtVisits" class="form-control form-control-sm wholenum"
                            ...
                            <div id="divAccInfoContainer">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="form-check form-check-inline col-sm-5">
                                        <input class="form-check-input" type="checkbox" id="chkModalCASA"
                                            value="divModalCASA" />
                                ...
                                <div class="row">
                                    <div class="form-check form-check-inline col-sm-5">
                                        <input class="form-check-input" type="checkbox" id="chkModalLoan"
                                            value="divModalLoanSelect" />
                                ...
                                <div class="row">
                                    <div class="form-check form-check-inline col-sm-5">
                                        <input class="form-check-input" type="checkbox" id="chkModalProducts"
                                            value="divModalOther" />
