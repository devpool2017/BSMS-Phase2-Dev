...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Site.Master"
    CodeBehind="UpdateClientDetails.aspx.vb" Inherits="LBP.VS2010.BSMS.UpdateClientDetails" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="../../Content/Scripts/PageScripts/TargetMarket/UpdateClientDetails.js" type="text/javascript"></script>
                ...
                <div class="accordion-body">
                    <div class="row mb-3">
                        ...
                        <div class="form-check form-check-inline col-sm-2">
                            <input class="form-check-input" type="checkbox" id="chkLead" value="1" name="chkStatus" />
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="txtLead" class="lbpControl form-control form-control-sm noForwardDate1Week
                                required requiredField" placeholder="Date" autocomplete="off" readonly="readonly" />
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="form-check form-check-inline col-sm-2">
                            ...
                            <input class="form-check-input" type="checkbox" id="chkVisited" />
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4" id="divIndustryType">
                        ...
                        <div class="col-sm-3">
                            <a id="btnEditIndustryType" class="lbpControl saveButton">Edit Industry Type</a>
                            <a id="btnRevertIndustryType" class="lbpControl cancelButton" hidden="hidden">Revert
                                Industry Type</a>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <div class="form-check form-check-inline col-sm-2" id="divLost">
                            <input class="form-check-input" type="checkbox" id="chkLostCustomer" value="0" />
                    ...
                    <div class="row mb-3" id="divLostFields">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="txtDateLost" class="lbpControl form-control form-control-sm noForwardDate1Week"
                                disabled="disabled" placeholder="Date" autocomplete="off" readonly="readonly" />
                        </div>
                        ...
                        <div class="col-sm-2">
                            <select id="ddlReason" class="lbpControl form-select form-select-sm hardcodedSelect"
                                disabled="disabled">
                            </select>
                        </div>
                        <div class="col-sm-5">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <%--                            <textarea id="txtChat" rows="5" cols="130" style="text-align: left;" class="lbpControl form-control form-control-sm required requiredField" disabled="disabled"
                                maxlength='<%#getFieldLength(FieldVariables.LOST_REMARKS, LengthSetting.MAX)%>'>
                            </textarea>--%>
                            <span id="txtChat" style="display: inline-block; background-color: white; border: 1px solid #ced4da;
                    ...
                    <div class="form-groupt" align="right">
                        <a id="btnUpdate" class="lbpControl saveButton">Update Target Market</a> 
                            ...
                            <div id="divAccInfoContainer">
                                <div class="row mb-2">
                                    <div class="form-check form-check-inline col-sm-5">
                                        <input class="form-check-input" type="checkbox" id="chkModalCASA" value="divModalCASA" />
                                ...
                                <div class="row">
                                    <div class="form-check form-check-inline col-sm-5">
                                        <input class="form-check-input" type="checkbox" id="chkModalLoan" value="divModalLoanSelect" />
                                ...
                                <div class="form-group" id="divModalLoan">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" id="txtModalDateReported" class="form-control form-control-sm noForwardBackwardDate "
                                                readonly="readonly" placeholder="Date" autocomplete="off" readonly="readonly" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label label-font-standard" for="txtModalOrigAmt">
                                ...
                                <div class="row">
                                    <div class="form-check form-check-inline col-sm-5">
                                        <input class="form-check-input" type="checkbox" id="chkModalProducts" value="divModalOther" />
                                ...
                                <div class="form-group" id="divModalOther">
                                    <div id="divModalProducts" class="form-group pagerDiv row mb-3">
                                        <table id="tblModalProducts" class="table table-sm scrollTable" align="center">
                                            ...
                                            <tbody id="tBodyModalProducts" class="scrollContent border align-middle" style="height: 100px;
                                                position: relative; overflow: auto; overflow-x: hidden;">
                                            </tbody>
                                        </table>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-3 col-form-label label-font-standard" for="txtModalDepositOther">
                                            Initial CASA Deposits (Products & Services)
                                        </label>
