...
function editSummaryBM(CPAID,ClientID,Fullname,Industry,DateEncoded,Lead,Prospect,Customer)
{
  var obj = new Object();
...
function deleteSummaryBM(CPAID,ClientID,Fullname,Industry,DateEncoded,Lead,Prospect,Customer)
{
    var obj = new Object();
    obj.CPAID = CPAID;
